...
public class PandemicHelpProvider extends HelpPageProvider {
    ...
    private static final String MODULE_PATH = getFrontPath() + "ext" + SEP + "docs" + SEP + "TrainingExercises" + SEP;
    ...
    public Map<String, String> getHelpMap() {
        ...
        map.put("au.gov.asd.tac.constellation.training.exercises.chapter4.ImportCustomCitiesPlugin", MODULE_PATH + "import-custom-cities.md");
        map.put("au.gov.asd.tac.constellation.training.exercises.chapter7.PandemicViewPane", MODULE_PATH + "pandemic-view.md");
        return map;
    }
    ...
    private static String getFrontPath() {
        ...
        frontPathBuilder.append("constellation-training").append(SEP)
                ...
                .append("constellation-training-exercises").append(SEP);
        if (isRunningLocally) {
