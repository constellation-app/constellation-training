...
public class PandemicHelpProvider extends HelpPageProvider {
    ...
    public String getHelpTOC() {
        return getFrontPath() + "ext" + SEP + "docs" + SEP + "TrainingExercises" + SEP + "src" + SEP + "au" + SEP + "gov" + SEP + "asd" + SEP + "tac" + SEP
                + CODEBASE_NAME + SEP + "training" + SEP + "exercises" + SEP + "pandemic-toc.xml";
    }
